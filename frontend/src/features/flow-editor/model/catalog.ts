...
export const NODE_CATALOG: NodeDefinition[] = [
  ...
  { type: "message", label: "Message", category: "Conversation", icon: MessageSquareText, accent: "blue", defaults: { label: "Message", message: "Enter a message", kind: "text" }, fields: [{ key: "label", label: "Label" }, { key: "message", label: "Message", kind: "textarea" }, { key: "kind", label: "Content type", kind: "select", options: ["text", "image", "video", "link"] }] },
  ...
  { type: "choice", label: "Choice", category: "Conversation", icon: ListChecks, accent: "teal", defaults: { label: "Choice", prompt: "Choose an option", options: "Option A\nOption B", mode: "single", variable: "choice" }, fields: [{ key: "label", label: "Label" }, { key: "prompt", label: "Prompt" }, { key: "options", label: "Options", kind: "textarea" }, { key: "mode", label: "Selection", kind: "select", options: ["single", "multiple"] }, { key: "variable", label: "Save as" }] },
  { type: "input", label: "Input", category: "Conversation", icon: TextCursorInput, accent: "green", defaults: { label: "Input", variable: "input", inputType: "text" }, fields: [{ key: "label", label: "Label" }, { key: "variable", label: "Save as" }, { key: "inputType", label: "Input type", kind: "select", options: ["text", "name", "email", "phone", "number", "date"] }] },
